...
public class GPTService {
    ...
    public String generateSummary(List<String> content){
        ...
        String assistantContent = "당신은 개발자와 디자이너가 프로젝트 진행 중 기록한 일기를 요약하는 AI 요약 도구입니다. " +
                ...
                "중요한 포인트: 요약 형식은 중요 포인트를 중심으로 간결하고 명확하게 일기 하나에 한 줄을 요약하며, '~했습니다.'와 같은 자연스러운 말투를 사용합니다. " +
                "여러 개의 일기를 요약한 후, 순서대로 나열해주세요. 또한, 사용자의 일기에 작성된 내용만 요약하고 당신이 새로 생성하는 내용이나 문장은 추가하지마세요.";
