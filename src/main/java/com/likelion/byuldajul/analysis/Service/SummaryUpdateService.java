...
import com.likelion.byuldajul.analysis.Repository.SummaryRepository;
...
public class SummaryUpdateService {
    ...
    public ResponseEntity<?> updateDiarySummary(@AuthenticationPrincipal CustomUserDetails userDetails, LocalDateTime date){
        // 특정 날짜의 일기 내용을 가져옴
        String diaryContent = diaryService.getDiaryForDate(userDetails.getUsername(), date);
        ...
        String summaryContent = gptService.generateSummary(diaryContent, date);
